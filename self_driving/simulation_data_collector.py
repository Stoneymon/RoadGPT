...
class SimulationDataCollector:
    ...
    def __init__(self, vehicle: Vehicle, beamng: BeamNGpy, road: DecalRoad,
                 ...
                 simulation_name: str = None, mesh_road: MeshRoad = None):
        ...
        self.mesh_road: MeshRoad = mesh_road
        ...
        self.simulation_data.set(self.params, self.mesh_road, self.road, self.states)
