...
from self_driving.road import DecalRoad, MeshRoad
...
SimulationDataRecordProperties = ['timer', 'pos', 'dir', 'vel', 'steering',
                                  ...
                                  'max_oob_percentage', 'oob_distance', 'oob_percentage', 'fuel', 'gforce_x', 'gforce_y', 'gforce_z']
...
class SimulationData:
    ...
    def __init__(self, simulation_name: str):
        ...
        self.path_height_img: Path = self.path_root.joinpath('height')
        self.id: str = None
        self.params: SimulationParams = None
        self.mesh_road: MeshRoad = None
    ...
    def set(self, params: SimulationParams, mesh_road: MeshRoad, road: DecalRoad,
            states: SimulationDataRecords, info: SimulationInfo = None):
        self.params = params
        self.mesh_road = mesh_road
        self.road = road
        if info:
            self.info = info
        else:
    ...
    def load(self) -> 'SimulationData':
        ...
        self.set(
            ...
            MeshRoad.from_dict(obj[self.f_road]),
